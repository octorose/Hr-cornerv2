...
export const MacbookScroll = ({
  ...
  const translate = useTransform(scrollYProgress, [0, 0.72], [0, 1500]);
  ...
  return (
    <div
      ref={ref}
      className="min-h-[250vh]  flex flex-col items-center py-0 md:py-24 justify-start flex-shrink-0 [perspective:800px] transform md:scale-100  scale-[0.35] sm:scale-50"
    >
      <motion.h2
        style={{
        ...
        className=" bg-white rounded-xl p-2 text-neutral-800 text-3xl font-bold mb-20 text-center"
      >
        {title || (
          <span>
      ...
      />
      {/* Base area */}
      <div className="h-[22rem] w-[37rem] bg-gray-200 dark:bg-[#272729] rounded-2xl overflow-hidden relative -z-10">
        {/* above keyboard bar */}
        <div className="h-10 w-full relative">
          <div className="absolute inset-x-0 mx-auto w-[80%] h-4 bg-[#050505]" />
        </div>
        <div className="flex relative">
          <div className="mx-auto w-[20%] overflow-hidden  h-full">
            <SpeakerGrid />
          </div>
          <div className="mx-auto w-[68%] h-full">
            <Keypad />
          </div>
          <div className="mx-auto w-[20%] overflow-hidden  h-full">
            <SpeakerGrid />
        ...
        {badge && <div className="absolute bottom-4  left-2">{badge}</div>}
      </div>
    </div>
  );
};
  ...
  return (
    <div className="relative [perspective:800px]">
      <div
        ...
        className="h-[12rem] w-[37rem] bg-[#010101] rounded-2xl p-2 relative"
      >
        <div
          style={{
      ...
      <motion.div
        ...
        className="h-96 w-[37rem] absolute inset-0 bg-[#010101] rounded-2xl p-2"
      >
...
export const Trackpad = () => {
  return (
    <div
      ...
      style={{
        boxShadow: "0px 0px 1px 2px #00000020 inset",
      }}
    ></div>
  );
};
