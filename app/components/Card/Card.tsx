...
function Card({ Departement, onClick }:any) {
  ...
  return (
    <div onClick={onClick} className="group bg-white dark:bg-gray-700/60 rounded-md p-2 shadow-[0_35px_60px_-15px_rgba(0,0,0,0.3)] transition-shadow duration-1000 hover:shadow-[0_20px_40px_-15px_rgba(255,255,255,0.3)]">
